...
const answerHandler = (e) => {
  ...
  switch(e.target.id) {
    case "Feed":
    result = "The cat is thankful for your offering";
    break;
    case "Scream" :
    result = "You are a cowardly excuse for a Human bean.";
    break;
    case "Stand" :
    result = "A brave choice. I'll tell you one thing: You've got guts. The cat stands on its hind legs and roars at you. Then raises its arms to play you in a match of Rock-Paper-Scissors.";
    break;
    case "Challenge":
