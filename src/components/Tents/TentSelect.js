    ...
    return(
      <div>
        ...
        <div className="TentSelect">
          <div id="tent1">
            <img onClick={this.props.tentSelected1} src={require("../images/Tent1.jpg")} />
          </div>
          <div id="tent2">
            <img onClick={this.props.tentSelected2} src={require("../images/Tent2.jpg")} />
          </div>
          <div id="tent3">
            <img onClick={this.props.tentSelected3} src={require("../images/Tent3.jpg")} />
          </div>
          <div id="tent4">
            <img onClick={this.props.tentSelected4} src={require("../images/Tent4.jpg")} />
          </div>
          <div id="tent5">
            <img onClick={this.props.tentSelected5} src={require("../images/Tent5.jpg")} />
          </div>
          <div id="tent6">
            <img onClick={this.props.tentSelected6} src={require("../images/Tent6.jpg")} />
          </div>
        </div>
      </div>
